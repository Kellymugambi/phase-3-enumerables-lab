...
def get_spicy_food_by_cuisine(spicy_foods, cuisine)
  # your code here
  spicy_foods.find do |spicyfood|
    spicyfood[:cuisine] == cuisine
  end
end
...
def print_spiciest_foods(spicy_foods)
  hottest_food = spicy_foods.select {|spicyfood| spicyfood[:heat_level] > 5}
  display_food = hottest_food.each do |food|
...
def average_heat_level(spicy_foods)
  # your code here
 add_heat = spicy_foods.sum {|food| food[:heat_level]}
 average_heat = add_heat / 3
end
